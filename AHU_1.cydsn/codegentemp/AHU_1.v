...
module top ;
	...
	cy_psoc3_pins_v1_10
		#(.id("07ae972f-f4f0-4269-824f-f54e343d7cbe"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	wire [7:0] tmpOE__MAX31865_CS_net;
	wire [7:0] tmpFB_7__MAX31865_CS_net;
	wire [7:0] tmpIO_7__MAX31865_CS_net;
	wire [0:0] tmpINTERRUPT_0__MAX31865_CS_net;
	electrical [0:0] tmpSIOVREF__MAX31865_CS_net;

	cy_psoc3_pins_v1_10
		#(.id("f62e7d35-40c1-40f7-86bf-b469cd8b4efa"),
		  .drive_mode(24'b110_110_110_110_110_110_110_110),
		  .ibuf_enabled(8'b1_1_1_1_1_1_1_1),
		  .init_dr_st(8'b1_1_1_1_1_1_0_0),
		  .input_clk_en(0),
		...
		MAX31865_CS
		 (.oe(tmpOE__MAX31865_CS_net),
		  .y({8'b0}),
		  .fb({tmpFB_7__MAX31865_CS_net[7:0]}),
		  .io({tmpIO_7__MAX31865_CS_net[7:0]}),
		  .siovref(tmpSIOVREF__MAX31865_CS_net),
		  .interrupt({tmpINTERRUPT_0__MAX31865_CS_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__MAX31865_CS_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{8'b11111111} : {8'b11111111};
	...
	cy_psoc3_pins_v1_10
		#(.id("1945b831-f34a-4b5c-afcd-aff42632281c"),
		  .drive_mode(3'b010),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("1bda1c95-aacd-4cc6-839d-2899976b19fb"),
    ...
    UART_v2_50_2 Wemos (
        ...
        .reset(1'b0),
        .rx(Net_613),
        .tx_interrupt(Net_614),
        .rx_interrupt(Net_615),
        .tx_data(Net_616),
        .tx_clk(Net_617),
        .rx_data(Net_618),
        .rx_clk(Net_619));
    ...
    UART_v2_50_3 RS485 (
        ...
        .reset(1'b0),
        .rx(Net_649),
        .tx_interrupt(Net_650),
        .rx_interrupt(Net_651),
        .tx_data(Net_652),
        .tx_clk(Net_653),
        .rx_data(Net_654),
        .rx_clk(Net_655));
	...
	cy_psoc3_pins_v1_10
		#(.id("abb27f6c-e728-4e82-969c-b5812d76e0f9"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("9f9ba15e-a3b2-4fed-8a13-027a8719146d"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
